...
export const metadata: Metadata = {
  ...
  description: "Dear friends & family memebers, We’re so excited to share this special moment with you! As we begin our journey together, we’d love for you to join us in celebrating our big day.",
};
