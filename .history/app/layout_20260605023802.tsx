...
export const metadata: Metadata = {
  ...
  description: "Dear friends & family memebers, we’re so excited to share this special moment with you! As we begin our journey together, we’d love for you to join us in celebrating our big day. Here, you’ll find all the details you need - our story, event schedule, venue information, RSVP and more.",
};
