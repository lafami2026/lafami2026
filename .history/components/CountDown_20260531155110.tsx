  ...
  return (
    <div className={styles.countdown}>
      <div className={styles.unit}>
        <span className={styles.uhead}>{time.days}</span>
        <span className={styles.caption}>Days</span>
      </div>

      <div className={styles.unit}>
        <span className={styles.uhead}>{time.hours}</span>
        <span className={styles.caption}>Hours</span>
      </div>

      <div className={styles.unit}>
        <span className={styles.uhead}>{time.minutes}</span>
        <span className={styles.caption}>Minutes</span>
      </div>

      <div className={styles.unit}>
        <span className={styles.uhead}>{time.seconds}</span>
