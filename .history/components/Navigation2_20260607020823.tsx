...
const Navigation2 = ({ ref, heroRef }: NavigationProps) => {
  ...
  return (
    <div className={styles.navigation} ref={navRef} key="two">
      <div className={`container ${styles.nav__container}`}>
        <div className={styles.nav__wrapper}>
          ...
          <div className={styles.rsvper} ref={rsvpRef}>
            ...
            <Link className={styles.button} href="/#rsvp">
              <span className={styles.rsvp}>RSVP</span>
              <span className={styles.svg} key="four">
                <DoubleLove key="three" />
              </span>
            </Link>
          </div>
        </div>
      ...
      <AnimatePresence mode="wait">
        {activeSide && (
          <SideBar2 activeSide={activeSide} setActiveSide={setActiveSide} />
        )}
      </AnimatePresence>
    </div>
  );
