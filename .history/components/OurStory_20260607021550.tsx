...
const OurStory = ({ sRef }: { sRef: RefObject<HTMLDivElement | null> }) => {
  return (
    <div className={styles.ourstory} ref={sRef} id="story">
      <div className={`container ${styles.os__container}`}>
        <div className={styles.os__wrapper}>
          ...
          <div className={styles.osw__ps}>
            ...
            <p className={`${styles.osw__p} ${styles.bold}`}>Then came 2025.</p>
            <p className={styles.osw__p}>
          ...
          <p className={styles.osw__p}>
            And now, here we are — grateful for a love built patiently over
            time, grounded in friendship, sustained by faith, and shaped by
