            ...
            <div className={styles.ssw__bottom}>
              <div className={styles.swb__one}>
                ...
                <div className={styles.buttons}>
                  <div className={styles.main__wrap}>
                    ...
                    <AddToCalendarButtons setActive={setActiveButton} activeButton={activeButton}/>
                  </div>
                  <Link href="https://maps.app.goo.gl/oRFLv8DZLwgSC8hp7" target="_blank" className={styles.button__two}>
              ...
              <div className={styles.swb__one}>
                ...
                <div className={styles.buttons}>
                  ...
                  <Link href="/" target="_blank" className={styles.button__two}>
                    <span>Get direction</span>
                    <span>
                      <Directions />
                    </span>
