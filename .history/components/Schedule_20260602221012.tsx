              ...
              <div className={styles.swb__one}>
                ...
                <div className={styles.special}>
                  <div className={styles.spec__one}>
                    ...
                    <p>Dress code To Be Confirmed</p>
                  </div>
                  <div className={styles.spec__one}>
                    <span>
                      <Location />
                ...
                <div className={styles.buttons}>
                  ...
                  <Link href="https://maps.app.goo.gl/B7LkZkcZ1qtPeb1V6?g_st=ac

This is more precise" target="_blank" className={styles.button__two}>
                    <span>Get direction</span>
                    <span>
                      <Directions />
                    </span>
