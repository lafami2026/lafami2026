...
const Schedule = ({ scRef }: { scRef: RefObject<HTMLDivElement | null> }) => {
  ...
  useEffect(() => {
    ...
    const handleOutsideClick2 = (e: MouseEvent): void => {
      if (!activeButton2) return;
      const el = targetRef2?.current;
      if (el && !el.contains(e.target as Node)) {
    ...
    document.addEventListener("pointerdown", handleOutsideClick2);
    return () => {
      document.removeEventListener("pointerdown", handleOutsideClick);
      document.removeEventListener("pointerdown", handleOutsideClick2);
    };
  }, [activeButton, targetRef, activeButton2, targetRef2]);

  return (
    <div className={styles.schedule} ref={scRef} id="schedule">
            ...
            <div className={styles.ssw__bottom}>
              <div className={styles.swb__one}>
                <div className={styles.timeline}>
                  <span className={styles.timer}>2:00 PM</span>
                      ...
                      <div className={styles.spl__bottom}>
                        <div className={styles.accent}>
                          <span className={styles.accspan}>
                            Dresscode Lead Colors
                          </span>
                          <div className={styles.colorss}>
                            {leadColors.map((data, i) => (
                              <div className={styles.cwrapp} key={i}>
                                <div
                                  className={styles.colorr}
                                  style={{
                        ...
                        <div className={styles.accent}>
                          <span className={styles.accspan}>
                            Dresscode Accent Colors
                          </span>
                          <div className={styles.colorss}>
                            {accentColors.map((data, i) => (
                              <div className={styles.cwrapp} key={i}>
                                <div
                                  className={styles.colorr}
                                  style={{
