    ...
    >
      <div className={styles.side__wrap}>
        ...
        <div className={styles.mid}>
          <Link className={styles.links} onClick={messageScroll}>
            Message
          </Link>
          <Link className={styles.links} onClick={detailsScroll}>
            Details
          </Link>
          <Link className={styles.links} onClick={storyScroll}>
            Our Story
          </Link>
          <Link className={styles.links} onClick={giftsScroll}>
            Gifts
          </Link>
