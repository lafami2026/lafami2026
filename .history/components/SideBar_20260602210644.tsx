    ...
    >
      <div className={styles.side__wrap}>
        ...
        <div className={styles.mid}>
          <span className={styles.links} onClick={() => setActiveSide(false)}>Message</span>
          <span className={styles.links} onClick={() => setActiveSide(false)}>Details</span>
          <span className={styles.links} onClick={() => setActiveSide(false)}>Our Story</span>
          <span className={styles.links} onClick={() => setActiveSide(false)}>Gifts</span>
          <span className={styles.links} onClick={() => setActiveSide(false)}>Schedule</span>
          <Link className={styles.links} href="/gallery" onClick={() => setActiveSide(false)}>Gallery</Link>
        </div>
